  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.Gabrielj.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.Gabrielj.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="GabrielJ" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="GabrielJ" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Gabriel Martins</span>
        </Link>
